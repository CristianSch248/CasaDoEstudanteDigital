...
routes.patch('/usuario/alterar/senha', validators.alterarSenhaUsuario, controller.alterarSenhaUsuario)
routes.delete('/usuario/desativar', validators.desativarUsuario, controller.desativarUsuario)
